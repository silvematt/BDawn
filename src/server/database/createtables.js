...
connection.connect(function(err) 
{
    ...
    else
    {
        ...
        var sqlQuery = "CREATE TABLE users (ID int NOT NULL AUTO_INCREMENT, username varchar(255) NOT NULL, email varchar(255), password varchar(255), creationDate DATETIME DEFAULT CURRENT_TIMESTAMP, characterCreated int DEFAULT 0, characterName varchar(255), characterSex int DEFAULT 0, characterClass int DEFAULT 0, characterVitality int DEFAULT 0, characterStrength int DEFAULT 0, characterDexterity int DEFAULT 0, characterAgility int DEFAULT 0, characterIntelligence int DEFAULT 0, characterFaith int DEFAULT 0, PRIMARY KEY (ID))";
